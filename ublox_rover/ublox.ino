...
//    uint8_t rtk_fixtype = myGNSS.getCarrierSolutionType();
//    uint8_t fix_type2 = myGNSS.getFixType();
//    bool fix_ok = myGNSS.getGnssFixOk();
//    uint8_t sat_num = myGNSS.getSIV();
    ...
    sprintf(tempstr, "TESUA:%d,%.9f,%.9f,%.4f,%.4f",rtk_fixtype,lat,lon,f_accuracy,f_msl);
